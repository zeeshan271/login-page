  ...
  function n(e) {
    1 == t("#light-mode-switch").prop("checked") && "light-mode-switch" === e
      ? (t("html").removeAttr("dir"),
        ...
        sessionStorage.removeItem("is_visited", "light-mode-switch"))
      ...
      ? (t("html").removeAttr("dir"),
        ...
        sessionStorage.removeItem("is_visited", "dark-mode-switch"))
      : 1 == t("#rtl-mode-switch").prop("checked") &&
        ...
        t("html").attr("dir", "rtl"),
        sessionStorage.removeItem("is_visited", "rtl-mode-switch"));
  }
